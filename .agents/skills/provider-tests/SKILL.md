---
name: provider-tests
description: Use when adding or updating YuClash Riverpod provider tests, notifier tests, or state-management tests in this repository.
---
...
- Do not use `dart test`; YuClash models and provider tests may depend on Flutter types.
